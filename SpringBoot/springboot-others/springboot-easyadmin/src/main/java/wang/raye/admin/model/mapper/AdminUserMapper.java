...
public interface AdminUserMapper {
	...
	@Delete({ "delete from admin_user", "where id = #{id,jdbcType=INTEGER}" })
	...
	@Results({
			...
			@Result(column = "flag", property = "flag", jdbcType = JdbcType.INTEGER),
			@Result(column = "last_login_time", property = "lastLoginTime", jdbcType = JdbcType.TIMESTAMP) })
	List<AdminUser> select(@Param("begin") int begin,
	...
	@Select({
			...
			"from admin_user", "where id = #{id,jdbcType=INTEGER}" })
	@Results({
			@Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "name", property = "name", jdbcType = JdbcType.VARCHAR),
			@Result(column = "psw", property = "psw", jdbcType = JdbcType.VARCHAR),
	...
	@Update({ "update admin_user", "set name = #{name,jdbcType=VARCHAR},",
