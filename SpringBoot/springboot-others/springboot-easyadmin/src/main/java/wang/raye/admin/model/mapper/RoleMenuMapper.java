...
public interface RoleMenuMapper {
	...
	@Delete({ "delete from role_menu",
			"where menuid = #{menuid,jdbcType=INTEGER}",
			"and roleid = #{roleid,jdbcType=INTEGER}" })
	int deleteByPrimaryKey(@Param("menuid") Integer menuid,
	...
	@Select({ "select", "menuid, roleid, flag, creator, create_time",
			"from role_menu", "where menuid = #{menuid,jdbcType=INTEGER}",
			"and roleid = #{roleid,jdbcType=INTEGER}" })
	@Results({
			@Result(column = "menuid", property = "menuid", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "roleid", property = "roleid", jdbcType = JdbcType.INTEGER, id = true),
			...
			@Result(column = "creator", property = "creator", jdbcType = JdbcType.INTEGER),
			@Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP) })
	RoleMenu selectByPrimaryKey(@Param("menuid") Integer menuid,
								@Param("roleid") Integer roleid);
