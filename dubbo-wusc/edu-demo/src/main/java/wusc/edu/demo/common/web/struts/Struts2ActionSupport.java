package wusc.edu.demo.common.web.struts;
...
import wusc.edu.demo.common.web.themes.dwz.DwzParam;
...
public class Struts2ActionSupport extends ActionSupport {
	...
	private static final Log LOG = LogFactory
			.getLog(Struts2ActionSupport.class);
	...
	public void write(String msg) {
		...
		try {
			ServletActionContext.getResponse().setHeader("Content-type",
	...
	public DwzParam getDwzParam(String statusCode, String message) {
		...
		return new DwzParam(statusCode, message, navTabId, dialogId,
				callbackType, forwardUrl, rel, null);
	}
	 ...
	 */
	protected String lengthValidate(String propertyName, String property,
			boolean isRequire, int minLength, int maxLength) {
	...
	public Map<String, Object> getParamMap() {
		...
		for (Object key : keys) {
			parameters.put(key.toString(),
					this.getString_UrlDecode_UTF8(key.toString()));
		}
		return parameters;
	}
