package wusc.edu.demo.common.web.themes.dwz;
 ...
 * navTabAjaxDone)"> form提交后返回json数据结构statusCode=DWZ.statusCode.ok表示操作成功,
 * 做页面跳转等操作. statusCode=DWZ.statusCode.error表示操作失败, 提示错误原因.
...
public class DwzParam {
	 ...
	 *            .
	 */
	public DwzParam(String statusCode, String message, String navTabId,
			String dialogId, String callbackType, String forwardUrl, String rel,
			String confirmMsg) {
	 ...
	 *            .
	 */
	public DwzParam(String navTabId, String callbackType, String forwardUrl,
			String rel) {
		this.navTabId = navTabId;
		this.callbackType = callbackType;
		this.forwardUrl = forwardUrl;
